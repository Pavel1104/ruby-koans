...
class AboutControlStatements < Neo::Koan
  ...
  def test_unless_statement
    ...
    assert_equal :false_value, result # same as saying 'if !false', which evaluates as 'if true'
  end
  ...
  def test_unless_statement_evaluate_true
    ...
    assert_equal :default_value, result # same as saying 'if !true', which evaluates as 'if false'
  end
